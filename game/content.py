...
UPGRADES = (
    Upgrade("damage", "重型弹匣", "武器伤害 +10%"),
    Upgrade("rapid", "热能枪机", "射击冷却 -5%"),
    Upgrade("accuracy", "精密校准", "弹道更稳，偏移 -18%"),
    Upgrade("crit_rate", "弹道解析", "暴击率 +5%"),
    Upgrade("crit_damage", "破甲核心", "暴击伤害 +15%"),
    Upgrade("speed", "轻翼战靴", "移动速度 +18"),
    Upgrade("max_hp", "强化核心", "最大生命 +10%，并回复 10% 生命"),
    Upgrade("heal", "战地修补", "立即回复 30% 生命"),
    Upgrade("shield_core", "相位护盾", "护盾上限 +10%，并回复 30% 护盾"),
    ...
    Upgrade("basketball_training", "篮球实习生", "坤坤：篮球体积增大，速度 +10%"),
    Upgrade("what_can_i_say", "what can i say", "曼巴重击眩晕延长，扇形角度增大"),
    ...
    Upgrade("credit_boost", "回收协议", "晶片获取 +20%"),
